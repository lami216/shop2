                ...
                return (
                        <div className='flex min-h-screen items-center justify-center bg-gradient-to-b from-[#0A050D] via-kingdom-plum/70 to-[#010104] p-6 text-center text-kingdom-ivory'>
                                <div className='max-w-md space-y-4 rounded-2xl border border-kingdom-gold/20 bg-black/40 p-6'>
                                        <h1 className='text-2xl font-bold text-kingdom-gold'>Messaging</h1>
                                        <p className='text-kingdom-ivory/70'>Please log in to access your messages.</p>
                                </div>
                        </div>
                );
        }
                                ...
                                <div className='lg:w-1/3'>
                                        <div className='rounded-2xl border border-kingdom-gold/20 bg-black/40 p-4 shadow-royal-soft'>
                                                <div className='mb-4 flex items-center justify-between'>
                                                        <h2 className='text-xl font-semibold text-kingdom-ivory'>Conversations</h2>
                                                        {loading && <span className='text-xs text-kingdom-ivory/70'>Loading...</span>}
                                                </div>
                                                {error && (
                                                ...
                                                {conversations.length === 0 && !loading ? (
                                                        <p className='text-sm text-kingdom-ivory/70'>No conversations yet.</p>
                                                ) : (
                                                        <ConversationList
